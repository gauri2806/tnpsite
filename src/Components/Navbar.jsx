  ...
  <div className="container d-flex align-items-center">
    ...
    <nav id="navbar" className="navbar order-last order-lg-0 ">
      <ul>
        ...
        <li><a href="temp.html">Our Team</a></li>
    ...
    <div className="social-wrap">
      ...
      <a href="https://twitter.com/tnpcell_sggsiet?t=NREWFQIc3udSvbbvD3AVgw&s=08" target="_blank">
      ...
      <a href="https://www.linkedin.com/company/placementcell-sggsiet/" target="_blank">
      ...
      <a href="https://instagram.com/tnpcell_sggsnanded?utm_medium=copy_link" target="_blank">
    ...
    <div className="socials-dropdown ms-auto">
      Socials
      <ul className="soc-list-container">
        <li>
          <a href="#" className="social-link">Instagram </a>
          <img src="/assets/img/insta logo.jpg" alt=""/>
        </li>
        <li>
        ...
        <li>
          <a href="#" className="social-link">Linked In</a>
        </li>
      </ul>
    </div>
